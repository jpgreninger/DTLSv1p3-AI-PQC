...
enum class DTLSError : int {
    ...
    DECRYPT_ERROR = 80,
    BAD_RECORD_MAC = 81,
    KEY_DERIVATION_FAILED = 82,
    SIGNATURE_VERIFICATION_FAILED = 83,
    CIPHER_SUITE_NOT_SUPPORTED = 84,
    CRYPTO_PROVIDER_ERROR = 85,
    RANDOM_GENERATION_FAILED = 86,
    KEY_EXCHANGE_FAILED = 87,
    INSUFFICIENT_SECURITY = 88,
    CRYPTO_HARDWARE_ERROR = 89,
