...
enum class DTLSError : int {
    ...
    SEQUENCE_NUMBER_EXHAUSTED = 26,
    EPOCH_MISMATCH = 27,
    RECORD_OVERFLOW = 28,
    FRAGMENTATION_ERROR = 29,
    EXTENSION_ERROR = 30,
    STATE_MACHINE_ERROR = 31,
    
    // Record layer errors (41-50)
    INVALID_RECORD_HEADER = 41,
    INVALID_PLAINTEXT_RECORD = 42,
    INVALID_CIPHERTEXT_RECORD = 43,
    INSUFFICIENT_BUFFER_SIZE = 44,
    INVALID_CONTENT_TYPE = 45,
    RECORD_LENGTH_MISMATCH = 46,
    UNSUPPORTED_RECORD_VERSION = 47,
    ...
    OUT_OF_ORDER_FRAGMENT = 74,
    MESSAGE_NOT_FOUND = 75,
    UNSUPPORTED_MESSAGE_TYPE = 76,
    SERIALIZATION_FAILED = 77,
    FLIGHT_IN_PROGRESS = 78,
    NO_CURRENT_FLIGHT = 79,
    INCOMPLETE_FLIGHT = 80,
    INVALID_FLIGHT = 81,
    RECORD_LAYER_NOT_AVAILABLE = 82,
    CRYPTO_PROVIDER_NOT_AVAILABLE = 83,
    EPOCH_NOT_FOUND = 84,
    EPOCH_OVERFLOW = 85,
    INVALID_EPOCH = 86,
    INVALID_CONNECTION_ID = 87,
    
    // Additional error codes
    INVALID_KEY_MATERIAL = 88,
    INVALID_IV_SIZE = 89,
    INITIALIZATION_FAILED = 90,
