...
enum class DTLSError : int {
    ...
    INVALID_STATE = 66,
    RESOURCE_EXHAUSTED = 67,
    HANDSHAKE_TIMEOUT = 68,
    
    // Message layer errors (69-89)
    INVALID_MESSAGE_FRAGMENT = 69,
    FRAGMENT_LENGTH_MISMATCH = 70,
    OVERLAPPING_FRAGMENT = 71,
    MESSAGE_NOT_COMPLETE = 72,
    SERIALIZATION_FAILED = 73,
    FLIGHT_IN_PROGRESS = 74,
    NO_CURRENT_FLIGHT = 75,
    INCOMPLETE_FLIGHT = 76,
    INVALID_FLIGHT = 77,
    RECORD_LAYER_NOT_AVAILABLE = 78,
    CRYPTO_PROVIDER_NOT_AVAILABLE = 79,
    EPOCH_NOT_FOUND = 80,
    EPOCH_OVERFLOW = 81,
    INVALID_CONNECTION_ID = 82,
    
    // Additional error codes
    INVALID_KEY_MATERIAL = 83,
    INVALID_IV_SIZE = 84,
    INITIALIZATION_FAILED = 85,
